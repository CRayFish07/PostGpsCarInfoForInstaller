...
public abstract class NetHandler extends Handler {
	...
	public static final int CALL_CLIENT_redisLog4App=700;
	public static final int BACK_CLIENT_redisLog4App=701;
	...
	public void handleMessage(Message msg) {
		...
		case BACK_CLIENT_getPostRoadTask4MobilePhone:
			...
			break;	
		case CALL_CLIENT_redisLog4App:
			CALL_CLIENT_redisLog4App(b);
			break;
		case BACK_CLIENT_redisLog4App:
			BACK_CLIENT_redisLog4App(b);
			break;	
		default:
			break;
		}
	...
	protected void BACK_CLIENT_redisLog4App(Bundle b) {
		Log.w(TAG, "空方法");		
	}

	protected void CALL_CLIENT_redisLog4App(Bundle b) {
		Log.w(TAG, "空方法");		
	}
